...
def train_models(panel, market_df):
    ...
    return dl_models, scaler, xgb_models, xgb_scalers, fusion_model, nlp_model, llm_model, val_dates
...
def main():
    ...
    if ret[0] is None:
        return
    dl_models, scaler, xgb_models, xgb_scalers, fusion_model, nlp_model, llm_model, val_dates = ret
